...
**Note: Current master is compatible with Substrate [polkadot-v0.9.26](https://github.com/paritytech/substrate/tree/polkadot-v0.9.26) branch.
...
* Make sure that you also have the Substrate [session pallet](https://github.com/paritytech/substrate/tree/master/frame/session) as part of your runtime. This is because the node-validators pallet is dependent on the session pallet.

```toml
[dependencies.node-validators]
default-features = false
package = 'node-validators'
git = 'https://github.com/SovereignWallet-Network/metamui-crates'
version = '0.0.1'
